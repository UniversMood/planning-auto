...
const InstructorCalendarView = () => {
  ...
  const getLessonColor = (type: string) => {
    switch (type) {
      case 'driving':
        return 'bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300 transition-colors duration-200';
      case 'code':
        return 'bg-purple-100 dark:bg-purple-900/30 text-purple-800 dark:text-purple-300 transition-colors duration-200';
      case 'exam':
        return 'bg-orange-100 dark:bg-orange-900/30 text-orange-800 dark:text-orange-300 transition-colors duration-200';
      default:
        return 'bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-300 transition-colors duration-200';
    }
  };
                ...
                return (
                  ...
                  >
                    {slotLessons.map((lesson) => (
                      <div
                        key={lesson.id}
                        className={`p-2 rounded text-xs mb-1 cursor-pointer ${getLessonColor(
                          lesson.type
                        )}`}
